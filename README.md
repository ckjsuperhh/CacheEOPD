<!--
  README.md - EOPD/verl 项目主文档
  中文摘要：本文件是 verl（Volcano Engine Reinforcement Learning）项目的 README 文档。
  verl 是由字节跳动 Seed 团队发起并由社区维护的 LLM 强化学习训练框架。
  EOPD（Entropy-gated On-Policy Distillation）是基于 verl 的 fork，
  专注于大语言模型的蒸馏研究。本文档包含项目介绍、安装指南、
  快速入门、支持的算法和模型等信息。
-->
<div align="center">
 👋 Hi, everyone!
