...
该脚本是 FlowRL 算法的训练入口点，使用 Hydra 配置系统和 Ray 分布式框架。
它加载 FlowRL 专用的训练器配置（flowrl_trainer.yaml），
并通过 RayFlowRLTrainer 启动 FlowRL 训练流程。
"""
"""
FlowRL 训练主入口脚本。
使用 Hydra 解析配置，初始化 Ray 集群，构建数据集、奖励函数和训练器，
启动 FlowRL 算法的 PPO 训练流程。
"""
