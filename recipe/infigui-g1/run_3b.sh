# ============================================================
# 脚本用途：使用 RLOO 算法训练 Qwen2.5-VL-3B 模型的 GUI 接地能力
# ============================================================
# 启动的训练任务：InfiGUI-G1 自适应探索策略优化
# 关键参数：
#   - algorithm.adv_estimator=rloo: 使用 RLOO 优势估计器
#   - custom_reward_function: 使用 AER 奖励函数（aer_gui_reward_function）
#   - actor_rollout_ref.rollout.n=8: 每个 prompt 采样 8 个响应
#   - rollout.name=sglang: 使用 sglang 推理后端
#   - trainer.total_epochs=6: 总训练轮数
# ============================================================
#!/bin/bash
set -x
ulimit -n 65535
