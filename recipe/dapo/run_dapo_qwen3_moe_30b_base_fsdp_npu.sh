#!/usr/bin/env bash
# =============================================================================
# DAPO 训练启动脚本 - Qwen3-MOE-30B FSDP NPU (昇腾) 版
#
# 用途：在 8 节点昇腾 NPU 集群（128 NPU）上使用 FSDP 策略训练 Qwen3-MOE-30B。
# 训练任务：针对混合专家模型（MOE）的大规模分布式训练配置，
#           使用 128 rank、batch_size=512 进行 DAPO 训练。
# =============================================================================
