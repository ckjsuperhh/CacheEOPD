#!/bin/bash
# ==============================================================================
# Moonlight/DeepSeek-V3 在线策略蒸馏训练启动脚本
# ==============================================================================
# 用途：通过 Ray job 提交 GKD 知识蒸馏训练任务
# 训练任务：
#   - 模型：Moonlight-16B-A3B-Instruct（MoE 架构，支持 EP/ETP 并行）
#   - 数据：GSM8K 训练集
#   - 后端：Megatron（Actor） + vLLM（Rollout）
#   - 调度：two_step_off 双缓冲流水线
# 关键参数：
#   - HF_MODEL_PATH: HuggingFace 模型路径
#   - DIST_CKPT_PATH: Megatron dist_ckpt 格式检查点路径
#   - PP/TP/EP/ETP/INFER_FP: 各种并行度配置
#   - TEACHER_SERVER_HOST/PORT: 教师模型服务地址
# ==============================================================================
set -x
