# ==============================================================================
# Qwen 模型 GKD 蒸馏训练测试脚本（vLLM 后端）
# ==============================================================================
# 用途：使用 Qwen3-0.6B 模型在 GSM8K 数据集上进行 GKD 蒸馏训练的快速测试
# 训练任务：
#   - 模型：Qwen3-0.6B（Dense 架构）
#   - 后端：Megatron（Actor） + vLLM（Rollout）
#   - 数据：GSM8K 训练集和测试集
# 关键参数：
#   - HF_MODEL_PATH: 模型路径
#   - PP/TP/EP/ETP: 均设为 1（单机小规模测试）
#   - trainer.total_training_steps=10: 仅运行 10 步用于验证
# ==============================================================================
set -x
