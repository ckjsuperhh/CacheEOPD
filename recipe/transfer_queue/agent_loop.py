...
"""
TransferQueue 智能体循环管理模块。

该模块扩展了 verl 框架的 AgentLoopManager，
集成 TransferQueue（高性能异步流式数据管理系统）来管理
多轮智能体交互中的批次分发、序列生成和性能指标统计。
在 EOPD/verl 框架中，它负责将异步 rollout 与 TransferQueue 数据管道打通。
"""
import asyncio
