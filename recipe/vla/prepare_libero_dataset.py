...
中文说明：
本脚本将 LIBERO 机器人操作基准数据集预处理为 parquet 格式。
主要流程：
1. 加载 libero_10 任务套件（10 个操作任务，每个 50 个初始状态）
2. 随机划分训练/测试任务（9 个训练，1 个 OOD 测试）
3. 训练集每个任务选 40 个初始状态，测试集选 10 个 ID + 20 个 OOD
4. 生成包含 task_id、state_id、task 描述等信息的数据集
"""
