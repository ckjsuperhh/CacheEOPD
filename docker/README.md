<!--
  docker/README.md - Docker 镜像构建指南
  中文摘要：本文件介绍了 verl/EOPD 项目的 Docker 镜像体系。
  包括预构建镜像的使用方式、基础镜像选择（vLLM/SGLang）、
  应用镜像的分层构建策略，以及不同 CUDA/PyTorch/vLLM/SGLang/Megatron-Core
  版本组合的 Dockerfile 使用说明。从 v0.6.0 开始使用 vllm/sglang
  官方镜像作为基础镜像，v0.7.0 起 vLLM 使用 nvidia/cuda 基础镜像。
-->
# Dockerfiles of verl
